...
data_inicial = dt.datetime(2020, 1, 15,  0,  0) #YYYY, M, D, H, Min
data_final = dt.datetime(2020, 6, 10,  23,  59)
...
plt.plot(serie_observada['q95'], label = "Q95", linewidth = 0.8, color = 'black')
